...
class BaseViewController: UIViewController, NavigationBarManagerDelegate {
	...
	override func viewDidLoad() {
		...
		self.navigationBarManager?.configureNavigationBar(model: NavigationBarModel(title: "prueba", backButton: .backArrow, backGroundColor: CustomColor.viewHighlight.uiColor))
